...
Config.Races = {
    ...
    {
        name = "Race 3",
        -- requiredVehicle = "sultan2", -- Specific vehicle required to enter this race
    ...
    {
        name = "Race 4",
        -- requiredVehicle = "vstr", -- Specific vehicle required to enter this race
        vehicleModel = 'vstr',
