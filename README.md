...
Place the mnc-timetrials folder in your server's resources directory. 📂
Add to server.cfg:
ensure ox_lib
ensure qb-core
...
Edit config.lua to define your races, buy-ins, rewards, and settings. ✏️
...
Debug Commands 🔧:Use these in-game with admin/developer permissions to configure the script:
...
Example:Config.BlacklistedVehicles = {
...
Customize Buy-ins & Rewards 💰:

Add wager tiers with amount, paymentType, or requiredItem for buy-ins, and payout or rewardItem for rewards.
Example:{ amount = 20, name = "Insane", timeModifier = 10, payout = 40, paymentType = "crypto", requiredItem = { name = "vipracepass", amount = 1 }, rewardItem = { name = "nitrous", amount = 1 } }
...
Example:#main-menu { top: 10%; left: 10%; width: 400px; }
